...
class MyApp
{
    ...
    protected $_flash_message_key='sike_message_pooo',$_flash_message;
    ...
    function dispatching(array $args = array())
    {
        ...
        if (isset($_SESSION))
        {
            $message = isset($_SESSION[$this->_flash_message_key])
                       ? $_SESSION[$this->_flash_message_key]
                       : null;
	...
	protected function _on_access_denied()
    {
        if(isset($_GET['sike']))
        {
            dump(QContext::instance()->requestUDI('array'));
        }else
        {
