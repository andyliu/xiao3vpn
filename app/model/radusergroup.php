...
class Radusergroup extends QDB_ActiveRecord_Abstract
{
    function username()
    {
        return '<a href="'. url('manage::radius/usergroup',array('username'=>$this->username,'groupname'=>$this->groupname)) .'">' . $this->username . '</a>';
    }

    function groupname()
    {
        return '<a href="'. url('manage::radius/usergroup',array('username'=>$this->username,'groupname'=>$this->groupname)) .'">' . $this->groupname . '</a>';
    }
